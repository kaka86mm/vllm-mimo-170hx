...
# 前置检查: 生产补丁(视觉修复+split-KV)必须存在
for _p in "$(dirname "$0")/../patches/mimo_v2_omni_model.py" "$(dirname "$0")/../patches/mimo_v2_omni.py" "$(dirname "$0")/../patches/triton_attn_diffkv.py"; do
